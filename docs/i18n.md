...
| `locales/{de,fr,it}/apback.json` | Translations only (Weblate + `bin/translate.mjs`) |
| `locale-src/{de,fr,it}/apback.json` | English snapshot for machine-translation diffing (CI/local only) |
...
node bin/translate.mjs locales/en/apback.json   # Gemini translate de/fr/it
